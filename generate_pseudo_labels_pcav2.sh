GPU_NUM=4 GPU_IDS=0,1,2,3, START_STAGE=1 END_STAGE=3 PORT=29802 TEST_PORT=29817 \
...
NAME="0803_score_pred_js_discret_lrzero_hard_eps" \
...
GPU_NUM=4 GPU_IDS=0,1,2,3 START_STAGE=1 END_STAGE=3 \
CFG_STAGE1=/media/ps/passport2/zlk/PointOBB-v2-vpd/configs/pointobbv2/train_cpm_dotav10.py \
CFG_STAGE2=/media/ps/passport2/zlk/PointOBB-v2-vpd/configs/pointobbv2/generate_pseudo_label_dotav10.py \
CFG_STAGE3=/media/ps/passport2/zlk/PointOBB-v2-vpd/configs/pointobbv2/redet_dotav10.py \
NAME="0801_orig_mmrotate_openmmlab_4gpu_lr01" \
ENABLE_FROZEN_V3_FINETUNE=False \
SAVE_VARIANCE_MAP=True \
RESUME_STAGE3=True \
DATA_ROOT=/media/ps/passport2/zlk/datasets/DOTAv10_split_ss/ \
